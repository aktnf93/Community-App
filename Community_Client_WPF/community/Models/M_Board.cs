...
{
    [DataContract]
    public class M_Board : Notify
    {
        public event NormalHandler<M_Board> BoardShowEvent;
        ...
        public event NormalHandler<M_Board> NewCommentCommitEvent;
        public event NormalHandler<M_Board> BoardDeleteCommitEvent;
