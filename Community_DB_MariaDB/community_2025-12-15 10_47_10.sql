...
) ENGINE=InnoDB AUTO_INCREMENT=28 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='직원 별 근태이력';

-- 테이블 데이터 community.tb_employee_attendance:~17 rows (대략적) 내보내기
...
) ENGINE=InnoDB AUTO_INCREMENT=77 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='게시글 리스트';

-- 테이블 데이터 community.tb_posts:~9 rows (대략적) 내보내기
INSERT INTO `tb_posts` (`id`, `post_category_id`, `employee_id`, `title`, `content`, `view_count`, `comment_count`, `post_level`, `comment_at`, `created_at`, `updated_at`, `deleted_at`) VALUES
	...
	(66, 1, 13, '송년회 일정 및 장소 안내', '# 송년회 일정 및 장소 안내\r\n\r\n- 많은 관심 부탁드립니다.', 3, 0, 1, NULL, '2025-11-19 06:14:46', '2025-12-12 06:31:21', NULL),
...
INSERT INTO `tb_post_category` (`id`, `parent_id`, `name`, `description`, `post_count`, `created_at`, `updated_at`) VALUES
	...
	(8, 7, '자유 게시판', NULL, 1, '2025-11-11 10:12:41', '2025-12-12 08:09:31'),
...
CREATE TABLE IF NOT EXISTS `tb_system_logs` (
  ...
  `created_at` timestamp NOT NULL DEFAULT current_timestamp() COMMENT '레코드 생성시각',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=47 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='시스템 로그';

-- 테이블 데이터 community.tb_system_logs:~31 rows (대략적) 내보내기
