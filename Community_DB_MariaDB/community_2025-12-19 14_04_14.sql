...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='결재 문서 공통';

-- 테이블 데이터 community.tb_approval_document:~0 rows (대략적) 내보내기
...
INSERT INTO `tb_employees` (`id`, `name`, `description`, `employee_code`, `employee_type`, `gender`, `birth_date`, `email`, `phone`, `address`, `image_path`, `status`, `joined_at`, `resigned_at`, `resigned_desc`, `team_id`, `rank_id`, `position_id`, `role_id`, `privilege_id`, `login_id`, `login_pw`, `is_active`, `created_at`, `updated_at`, `deleted_at`) VALUES
	(13, '시스템 관리자', '초창기 직원', 'A0001', '정규직', '남', '2025-11-19', 'jameson@123.com', '000-1234-5678', '서울특별시 강남구 서초길 럭셔리브랜드아파트 1232-567, 1999호', '/uploads\\A0002.png', '재직', '2025-11-19 08:30:50', '2025-12-08 13:29:28', '자진퇴사', 31, 14, 10, 12, 2, '123', '123', 'Y', '2025-11-11 05:15:04', '2025-12-12 06:04:24', NULL),
...
) ENGINE=InnoDB AUTO_INCREMENT=30 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='직원 별 근태이력';

-- 테이블 데이터 community.tb_employee_attendance:~19 rows (대략적) 내보내기
...
INSERT INTO `tb_posts` (`id`, `post_category_id`, `employee_id`, `title`, `content`, `view_count`, `comment_count`, `post_level`, `comment_at`, `created_at`, `updated_at`, `deleted_at`) VALUES
	...
	(63, 1, 13, '동호회 지원금 신청 공지', '# 동호회 지원금 신청 공지\r\n\r\n- 많은 관심 부탁드립니다.', 4, 0, 1, NULL, '2025-11-13 06:53:58', '2025-12-12 08:40:04', NULL),
	...
	(67, 1, 13, '신규 사내 규정 적용 일정', '# 신규 사내 규정 적용 일정\r\n\r\n- 많은 참석 바랍니다.', 51, 6, 1, '2025-12-11 08:35:32', '2025-11-19 06:16:12', '2025-12-12 08:25:02', NULL),
...
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='게시글 별 댓글';

-- 테이블 데이터 community.tb_post_comments:~6 rows (대략적) 내보내기
...
CREATE TABLE IF NOT EXISTS `tb_schedule` (
  ...
  `description` varchar(255) NOT NULL DEFAULT '' COMMENT '일정 설명',
...
-- 테이블 데이터 community.tb_schedule:~0 rows (대략적) 내보내기
