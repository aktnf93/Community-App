...
-- 테이블 데이터 community.tb_approval_document:~6 rows (대략적) 내보내기
...
) ENGINE=InnoDB AUTO_INCREMENT=33 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='직원 별 근태이력';

-- 테이블 데이터 community.tb_employee_attendance:~23 rows (대략적) 내보내기
INSERT INTO `tb_employee_attendance` (`id`, `employee_id`, `start_work_at`, `end_work_at`, `description`, `created_at`, `updated_at`) VALUES
	...
	(32, 13, '2025-12-23 01:31:35', NULL, NULL, '2025-12-23 01:31:35', '2025-12-23 01:31:35');
...
INSERT INTO `tb_posts` (`id`, `post_category_id`, `employee_id`, `title`, `content`, `view_count`, `comment_count`, `post_level`, `comment_at`, `created_at`, `updated_at`, `deleted_at`) VALUES
	...
	(66, 1, 13, '송년회 일정 및 장소 안내', '# 송년회 일정 및 장소 안내\r\n\r\n- 많은 관심 부탁드립니다.', 4, 0, 1, NULL, '2025-11-19 06:14:46', '2025-12-15 10:09:08', NULL),
...
-- 테이블 데이터 community.tb_schedule:~21 rows (대략적) 내보내기
